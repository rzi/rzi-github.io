...
function chartUpdate(content) {
  ...
  for (i = 0; i < Object.keys(content).length; i++) {
    ...
    console.log(
      `chart.data.datasets[0].data[i]=${chart.data.datasets[0].data[i]}`
    );
  }
  chart.update();
}
